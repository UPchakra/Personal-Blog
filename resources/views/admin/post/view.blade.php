            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                     ...
                     <div class="btn-group">
                                    <a href="{{route('addpost')}}" id="addRow"
                            ...
                            <tbody>
                                ...
                                <tr>
                                   <td>{{$loop->index+1}}</td>
                                    ...
                                    <td>
                                        <a href="{{route('showpost',$value->id)}}"class="btn btn-default"><i class="zmdi zmdi-eye"></i></a>

                                        <a href="{{route('editpost',$value->id)}}" class="btn btn-default waves-effect waves-float waves-green"><i class="zmdi zmdi-edit"></i></a>

                                        <a href="javascript:void(0);" rel="{{$value->id}}" rel1="delete-post" class="btn btn-default  deleteRecord"><i class="zmdi zmdi-delete"></i></a>
