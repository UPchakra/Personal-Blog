...
@section('siteTitle') Dashboard @endsection
                       ...
                       <ul class="inbox-widget list-unstyled clearfix">
                            <li class="inbox-inner"><a href="#">
                               <div class="inbox-item">
                                   <div class="inbox-img"> <img src="{{asset('public/adminAssets/assets/images/sm/avatar1.jpg')}}" class="rounded" alt=""> </div>
                            ...
                            <li class="inbox-inner"> <a href="#">
                                <div class="inbox-item">
                                   <div class="inbox-img"> <img src="{{asset('public/adminAssets/assets/images/sm/avatar2.jpg')}}" class="rounded" alt=""> </div>
                                   <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('public/adminAssets/assets/images/sm/avatar3.jpg')}}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('public/adminAssets/assets/images/sm/avatar4.jpg')}}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-img"><img src="{{asset('public/adminAssets/assets/images/sm/avatar5.jpg')}}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
                            ...
                            <li class="inbox-inner"> <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-img"> <img src="{{asset('public/adminAssets/assets/images/sm/avatar6.jpg')}}" class="rounded" alt=""> </div>
                                    <div class="inbox-item-info">
